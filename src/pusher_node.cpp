...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle nh;
    if (!ros::Time::waitForValid(ros::WallDuration(30.0))) // NOTE: Important when using simulated clock
    {
    ...
    /****************************************************************/
    ros::ServiceClient pushclient = nh.serviceClient<robotic_pusher::getVelocity>("velocity_service");
